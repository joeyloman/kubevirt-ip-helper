...
func TestIpam(t *testing.T) {
	...
	testSubnets := []struct {
		...
		},
		{
			...
			want:   fmt.Errorf("start address 192.168.1.10 is not within subnet 192.168.0.0/24 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 192.168.1.125 is not within subnet 192.168.0.0/24 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 192.168.0.100 is smaller then the start address 192.168.0.200: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 192.168.0.255 equals the broadcast address 192.168.0.255: %w", ErrSubnetInvalid),
		},
		{
		...
		},
		{
			...
			want:   fmt.Errorf("start address 172.10.0.10 is not within subnet 172.16.0.0/16 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 172.200.1.125 is not within subnet 172.16.0.0/16 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 172.16.0.100 is smaller then the start address 172.16.180.10: %w", ErrSubnetInvalid),
		},
		{
		...
		},
		{
			...
			want:   fmt.Errorf("start address 11.0.0.10 is not within subnet 10.0.0.0/8 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 250.255.255.254 is not within subnet 10.0.0.0/8 range: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 10.10.227.10 is smaller then the start address 10.255.255.253: %w", ErrSubnetInvalid),
		},
		{
			...
			want:   fmt.Errorf("end address 10.255.255.255 equals the broadcast address 10.255.255.255: %w", ErrSubnetInvalid),
		},
		{
